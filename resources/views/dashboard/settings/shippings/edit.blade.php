...
@section("title",$shipping_method->key)
@section("content")
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    <form class="form" action="{{route("update.shpping.method",$shipping_method->id)}}"
                                          method="post"
                                                    ...
                                                    <div class="form-group">
                                                     ...
                                                     <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" value="{{$shipping_method -> plain_value}}" id="plane_value"
                                                                   class="form-control"
                                                                   placeholder="  "
                                                                   name="plane_value">
                                                            @error("plain_value")
